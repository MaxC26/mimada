    ...
    <div className='w-full bg-[#faf7f5] rounded-[2rem] p-8 md:p-12 mb-10 md:mb-14 flex flex-col md:flex-row items-center justify-between shadow-sm relative overflow-hidden'>
      <div className='w-full md:w-1/2 z-10'>
        ...
        <Link
          ...
          className='bg-[#c2a381] text-white px-8 py-3.5 rounded-full font-bold text-lg hover:bg-[#a58b6c] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 w-full md:w-auto shadow-md'
        >
          Empieza Ahora
        </Link>
      </div>
